const en = {
  ...
  home: {
    ...
    playerDirectoryNav: 'Player Directory',
    quickLinkPlayerDirectorySubtitle: 'Search kingdom players',
  ...
  players: {
    ...
    subtitle: 'Self-reported roster for Kingdom 1781 -- search by name, ID, or alliance.',
    searchPlaceholder: 'Search by name, ID, or alliance...',
    addProfileButton: 'Add / Update My Profile',
    ...
    fieldPower: 'Power',
    fieldKills: 'Kills',
    fieldVipLevel: 'VIP Level',
    fieldFurnaceLevel: 'Furnace / TC Level',
    fieldKingdom: 'Kingdom',
    submitButton: 'Save Profile',
    submitting: 'Saving...',
    errorGeneric: 'Something went wrong -- try again.',
    noResults: 'No players match your search yet.',
    colName: 'Name',
    colUpdated: 'Updated',
    notFound: 'Player not found.',
    backToDirectory: 'Back to Player Directory',
